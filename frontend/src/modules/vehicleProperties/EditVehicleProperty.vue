  ...
  <div>
    ...
    <CForm @submit.prevent="submitProperty">
      <CInput
        label="Header Name"
        id="header-name"
        v-model="currProperty.headerName"
      />
      <CSelect
        label="Input Type"
        id="input-type-cmb"
...
export default {
  ...
  data() {
    return {
      ...
      errorMessage: null,
      currProperty: {
        headerName: this.property.headerName,
  ...
  methods: {
    ...
    submitProperty() {
      ...
      if (this.currProperty.headerName == '' || this.currProperty.inputType == '') {
      ...
      // parse the options
      let options = [];
      if (this.currProperty.inputType == 'Options' && !this.currProperty.options.includes(';')) {
      ...
      const newProperty = {
        headerName: this.currProperty.headerName,
